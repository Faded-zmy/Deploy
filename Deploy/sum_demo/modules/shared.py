...
summary_model = None
sum_merge_model = None
topic_merge_model = None

vicuna_prompt = "A chat between a curious human and an artificial intelligence assistant.The assistant gives helpful, detailed, and polite answers to the human's questions"
...
# # parser.add_argument('--api-port', type=int, default=5000, help='The listening port for the blocking API.')
...
# parser.add_argument('--lora_weight_path', type=str, default=None, help='the lora weight path of the character.')
# #tweet weight path
# parser.add_argument('--tweet_model', type=str, default=None, help='the tweet model path of the character.')
