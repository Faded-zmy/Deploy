...
def setup():
    ...
    # blocking_api.start_server(shared.args.api_port, share=shared.args.public_api)
    # streaming_api.start_server(shared.args.api_port, share=shared.args.public_api)
